    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <Card className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground">Total de drogas</p>
      ...
      <Card className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground">Vencimiento pronto</p>
      ...
      <Card className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground">Emitido hoy</p>
      ...
      {expiringSoonDrugs > 0 && (
        <div className="col-span-full">
          <Alert variant="destructive">
            ...
            Los siguientes medicamentos se encuentran en stock limitado:
            ...
            <div className="mt-4">
              <Button variant="ghost" className="hover:underline">
                <Link href="/pharmacy/drugs/expire">Ver detalles</Link>
              </Button>
            </div>
          </Alert>
        </div>
