  ...
  return (
    <Card className="rounded-xl p-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-lg font-semibold">Doctores disponibles</h1>
        {(await checkRole("ADMIN")) && (
          ...
          >
            <Link href="/record/doctors">Ver todo</Link>
          </Button>
        )}
      </div>
        ...
        {data?.map((doc, id) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-base capitalize text-gray-600 dark:text-gray-400">
                {doc?.specialization}
              </p>
              <p className="text-sm flex items-center">
                <span className="hidden lg:flex">Tiempo disponible:</span>{" "}
